const Work = () =>
    <section className='*:uppercase min-h-[100dvh] flex flex-col justify-center gap-y-15 md:gap-y-30'>
        ...
        <ul className='text-4xl md:text-6xl xl:text-8xl flex flex-col justify-center *:p-5 md:*:p-10 xl:*:p-20 *:border-neutral-800 *:border-t-1 *:last:border-b-1 *:text-neutral-500 *:hover:text-white *:cursor-pointer *:transition-colors'>
            <li>Katt</li>
            <li>Krypton</li>
        </ul>
    </section>
