...
const projects: Project[] = [
  {
    ...
    title: "Finns",
    description:
      "An interactive booking engine optimized for high conversion, designed for FINNS Beach Club—Bali’s most visited destination.",
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Easily share selected seats to enable faster decision-making.",
      },
    ],
    ...
    demo: "https://finns-eight.vercel.app/",
  },
  {
    type: "frontend",
    slug: "krypton",
  ...
  },
  {
    ...
    title: "Katt",
    description:
      "Katt is an easy-to-use blog CMS for gallery-style blogs with heavy image use. It’s suitable for architecture or interior design websites.",
